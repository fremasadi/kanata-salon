    ...
    <div class="container mx-auto px-4">
        ...
        <div x-show="mobileMenu" x-cloak class="md:hidden pb-4">
            <div class="flex flex-col space-y-3">
                ...
                @if (Route::has('login'))
                    @auth
                        <!-- <a href="{{ route('cart.index') }}" class="text-gray-700 hover:text-[#EC008C] transition duration-300 flex items-center">
                            ...
                            @endphp
                            @if($cartCount > 0)
                                <span class="ml-2 bg-[#EC008C] text-white text-xs px-2 py-1 rounded-full">{{ $cartCount }}</span>
                            @endif
                        </a> -->
